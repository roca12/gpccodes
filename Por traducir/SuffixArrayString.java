...
// Java code for implementation of Suffix Array String

import java.util.Arrays;
import java.util.TreeMap;

public class SuffixArrayString {
    //Sorted map for all suffix with begin index
    static TreeMap<Integer, Suffix> suffixes = new TreeMap<>();
...
// Return the suffix array 
    ...
    public static void main(String[] args) {
        ...
        suffixes.entrySet().forEach((entry) -> {
            System.out.println("index: " + entry.getKey() + ". suffix: " + txt.substring(entry.getValue().index));
        });
        System.out.println("Following is suffix array for "+txt+" sorted:");
        printArr(suff_arr, n);
    }
}

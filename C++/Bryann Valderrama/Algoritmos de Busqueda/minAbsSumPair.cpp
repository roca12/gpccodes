...
void minAbsSumPair(int lista[], int n)
{
    ...
    cout << "Los dos elementos los cuales tienen la suma minima son " << lista[min_izq] << " y " << lista[min_der] << endl;
}

int main(int argc, char const *argv[])
{
    int lista[] = {1, 60, -10, 65, -43, 34};
    minAbsSumPair(lista, sizeof(lista) / sizeof(lista[0]));
    return 0;
}

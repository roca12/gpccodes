...
public class StringHashing {
    ...
    public static void main(String[] args) {
        ...
        Hashing hashing= new Hashing(str);
        System.out.println(hashing.hash(0, str.length()));
        System.out.println(hashing.hash(0, str.length()-1));
        System.out.println(hashing.hash(0, str.length()-2));
        System.out.println(hashing.hash(1, 2));
    }
}
